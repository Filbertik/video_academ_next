...
export default function ViralVideoCoursePage() {
  ...
  return (
    <div className="min-h-screen bg-[#0b0117] relative overflow-hidden">
      {/* Декоративні елементи фону (залишаємо тільки фіолетову пляму) */}
          ...
          <div className="flex flex-col lg:flex-row items-start justify-between max-w-[1440px] mx-auto gap-8">
            ...
            <div className="relative w-full lg:w-1/2 flex flex-col items-start gap-6">
              ...
              <div className="flex items-end gap-4">
                ...
                <span className="text-[18px] font-semibold text-white line-through">1200 грн</span>
              </div>
            </div>
...
//       <div className="absolute inset-0">
//         <div
//           className="absolute top-[147px] left-[56px] w-[644px] h-[466px] rounded-[18px] bg-cover bg-center bg-no-repeat"
...
//         <section className="w-full px-4 sm:px-6 lg:px-8 mt-[100px] md:mt-[120px] lg:mt-[150px]">
//           <div className="flex flex-col lg:flex-row items-start justify-between max-w-[1440px] mx-auto gap-8">
//             {/* Ліва колонка: зображення + кнопка + ціни */}
//             <div className="relative w-full lg:w-1/2 flex flex-col items-start gap-6">
//               {/* Зображення */}
//               <img
//                 src="/images/img_image_2.png"
